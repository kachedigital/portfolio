...
import { ArrowLeft, Send, Brain, Zap, Palette, Accessibility } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Custom AI solutions to automate workflows and enhance productivity",
    ...
    },
    {
      ...
      description: "User-centered design solutions for modern interfaces and digital products",
    ...
    },
    {
      ...
      icon: <Accessibility className="w-8 h-8 text-accent-purple" />,
      color: "purple",
    },
  ]
      ...
      >
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/services" className="flex items-center gap-2 font-medium text-accent-orange">
              Services
            </Link>
            <Link
              href="/projects"
            ...
            <div className="text-center mb-16">
              <TextReveal>
                <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 bg-gradient-to-r from-orange-400 via-pink-500 to-purple-500 bg-clip-text text-transparent drop-shadow-subtle">
                  <AnimatedText text="Services Coming Soon" />
                </h1>
              </TextReveal>

              <div className="max-w-3xl mx-auto">
                <p className="text-xl text-zinc-300 mb-12">
                  We're crafting a comprehensive suite of services to help you transform your digital presence. From AI
                  development to accessibility solutions, we're building something special for you.
                </p>
                ...
                {!isSubmitted ? (
                  <div className="bg-bg-secondary rounded-xl p-8 shadow-[0_15px_30px_rgba(0,0,0,0.4)] border border-accent-purple/30 backdrop-blur-sm">
                    ...
                    <p className="text-zinc-400 mb-6">
                      Be the first to know when our services are available. Leave your email for updates and special
                      offers.
                    </p>
                  ...
                  <div className="bg-bg-secondary rounded-xl p-8 shadow-[0_15px_30px_rgba(0,0,0,0.4)] border border-accent-purple/30 backdrop-blur-sm">
                    <div className="text-center">
                      ...
                      <p className="text-zinc-400">
                        You're on the list! We'll notify you when our services are available.
                      </p>
                    </div>
                  </div>
                )}
